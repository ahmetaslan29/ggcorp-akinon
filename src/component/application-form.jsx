...
const RegistrationForm = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8  rounded-lg  my-5">
      <h1 className="text-3xl font-bold text-center text-[#d2b86a] mb-6">Takım Kayıt Formu</h1>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 ">
          <label className="block " >
            ...
            <input
              type="text"
              name="fullName"
              className="mt-1 block w-full px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-200"
              required
            />
          </label>
        ...
        <div className="space-y-6">
          <h2 className="text-2xl font-semibold text-[#d2b86a]">Takım Üyeleri (Opsiyonel)</h2>
          ...
          <button
            ...
            ref={addButtonRef}
            className={`w-full py-2 px-4  text-black rounded-md shadow-md bg-white hover:bg-[#d2b86a] hover:text-white focus:outline-none `}
          >
            Takım Üyesi Ekle
          </button>
        </div>
